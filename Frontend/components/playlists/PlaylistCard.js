...
// 플레이리스트 썸네일 (2x2 이미지 격자) - 메모이제이션
const PlaylistThumbnail = memo(({ coverImages, isLiked, onLikePress }) => {
  ...
  return (
    <View style={styles.thumbnailGrid}>
      <View style={styles.gridRow}>
        <Image source={imageSlots[0]} style={styles.gridImage} cachePolicy="memory-disk" contentFit="cover" />
        <Image source={imageSlots[1]} style={styles.gridImage} cachePolicy="memory-disk" contentFit="cover" />
      </View>
      <View style={styles.gridRow}>
        <Image source={imageSlots[2]} style={styles.gridImage} cachePolicy="memory-disk" contentFit="cover" />
        <Image source={imageSlots[3]} style={styles.gridImage} cachePolicy="memory-disk" contentFit="cover" />
      </View>
      <TouchableOpacity style={styles.thumbnailHeartButton} onPress={onLikePress}>
        <Ionicons 
          name={isLiked ? "heart" : "heart-outline"} 
          size={20} 
          color={isLiked ? "#d84753ff" : "#ffffff"} 
        />
      </TouchableOpacity>
    </View>
  );
